...
Uses SQLAlchemy 1.4 compatible syntax to work with Airflow 2.9.2
"""
...
# ---------------------------------------------------------------------------
# Base class — SQLAlchemy 1.4 compatible syntax
# ---------------------------------------------------------------------------
Base = declarative_base()


# ---------------------------------------------------------------------------
# WeatherRecord — maps to 'weather_records' table
# ---------------------------------------------------------------------------
class WeatherRecord(Base):
    ...
    # Timestamp fields
    extracted_at         = Column(String(30),  nullable=True)
    created_at           = Column(
